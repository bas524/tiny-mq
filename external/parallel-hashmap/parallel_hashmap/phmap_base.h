...
// instance.
//
// `SizeSeq...` is `[0, NumSizes)` where `NumSizes` is the _number of arguments
// passed to `Layout::Partial()` or `Layout::Layout()`.
//
// `OffsetSeq...` is `[0, NumOffsets)` where `NumOffsets` is
// `Min(sizeof...(Elements), NumSizes + 1)` (the _number of arrays for which we
// can compute offsets).
// ---------------------------------------------------------------------------
...
public:
    ...
    // The _number of elements in the Nth array. This is the Nth argument of
    ...
    // The _number of elements in the array with the specified element type.
    ...
    // The _number of elements of all arrays for which they are known.
...
public:
    ...
    //
    // Note: The sizes of the arrays must be specified in _number of elements,
    // not in bytes.
